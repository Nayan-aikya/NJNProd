...
class training_centres extends Model
{
    ...
    public function fetchtcforList($district){
    	$tc = training_centres::where('district',$district)->pluck('centre_name','centre_id');     
        return $tc;
    }
    ...
    public function fetchPendingTcListByDistrict($district){
        $training_centres = training_centres::where('district',$district)->where('centre_status','created')->get(); 
        return $training_centres;
    }
